        ...
        form.addEventListener('submit', function (e) {
            ...
            if (!guessInput && submitButton) {
                ...
                if (submitText === 'PLAY AGAIN' || submitText === 'TRY AGAIN') {
                    // Redirect to the root path if guessInput is null and button text is 'PLAY AGAIN'
                    window.location.href = '/game?user=' + user.value;
                    return;
                }
            }            

            if (!guessInput && submitButton && submitButton.textContent.trim().toUpperCase() === 'PLAY AGAIN') {
                // Redirect to the root path if guessInput is null and button text is 'PLAY AGAIN'
